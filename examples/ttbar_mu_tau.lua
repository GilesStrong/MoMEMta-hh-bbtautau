...
if USE_PERM then
    ...
    add_reco_permutations(bjet1, bjet0)
end
...
if USE_TF then
    GaussianTransferFunctionOnEnergy.tf_p1 = {
        ps_point = add_dimension(),
        reco_particle = tau0.reco_p4,
        sigma = 0.10,
    }
    tau0.set_gen_p4("tf_p1::output")
    ...
    GaussianTransferFunctionOnEnergy.tf_p3 = {
        ps_point = add_dimension(),
        reco_particle = tau1.reco_p4,
        sigma = 0.05,
    }
    tau1.set_gen_p4("tf_p3::output")
...
Looper.looper = {
    ...
    MatrixElement.ttbar = {
      ...
      matrix_element = 'ttbar_mu_tau_sm_P1_Sigma_sm_gg_tapvtbmumvmxbx',
      matrix_element_parameters = {
          card = '../MatrixElements/ttbar_mu_tau/Cards/param_card.dat',
      },
