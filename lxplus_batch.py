...
def makeJOFile(start, stop, inputFile, queue):
    ...
    joFile.write(installPrefix + "ttbar_mu_tau.exe -i " + inputFile + " -s" + str(start) + " -e" + str(stop))
    joFile.close()
...
if __name__ == "__main__":
    ...
    parser.add_option("-i", "--input", dest = "input", action = "append", default = ["mu_tau_b_b_MCData.root"], help = "Input file")
