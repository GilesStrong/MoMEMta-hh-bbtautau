...
#include <P1_Sigma_sm_gg_tapvtbmumvmxbx.h> 
...
P1_Sigma_sm_gg_tapvtbmumvmxbx::P1_Sigma_sm_gg_tapvtbmumvmxbx(const
    ParameterSet& configuration)
{
  ...
  mapFinalStates[{-15, 16, 5, 13, -14, -5}] = 
  {
    {
      &P1_Sigma_sm_gg_tapvtbmumvmxbx::matrix_1_gg_ttx_t_wpb_wp_tapvt_tx_wmbx_wm_mumvmx, 
      false, 
      {
        std::make_pair(21, 21)
      }, 
    ...
    , 
    {
      &P1_Sigma_sm_gg_tapvtbmumvmxbx::matrix_1_uux_ttx_t_wpb_wp_tapvt_tx_wmbx_wm_mumvmx, 
      true, 
      {
...
void P1_Sigma_sm_gg_tapvtbmumvmxbx::resetHelicities() 
{
...
std::map < std::pair < int, int > , double >
    P1_Sigma_sm_gg_tapvtbmumvmxbx::compute(const std::pair <
...
void P1_Sigma_sm_gg_tapvtbmumvmxbx::calculate_wavefunctions(const int perm[],
    const int hel[])
{
...
double P1_Sigma_sm_gg_tapvtbmumvmxbx::matrix_1_gg_ttx_t_wpb_wp_tapvt_tx_wmbx_wm_mumvmx() 
{
...
double P1_Sigma_sm_gg_tapvtbmumvmxbx::matrix_1_uux_ttx_t_wpb_wp_tapvt_tx_wmbx_wm_mumvmx() 
{
...
REGISTER_MATRIX_ELEMENT("ttbar_mu_tau_sm_P1_Sigma_sm_gg_tapvtbmumvmxbx",
    ttbar_mu_tau_sm::P1_Sigma_sm_gg_tapvtbmumvmxbx);
