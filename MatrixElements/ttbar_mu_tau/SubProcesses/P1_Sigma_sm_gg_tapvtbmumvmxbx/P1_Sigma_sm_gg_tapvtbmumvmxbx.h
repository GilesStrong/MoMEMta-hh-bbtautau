...
class P1_Sigma_sm_gg_tapvtbmumvmxbx: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_gg_tapvtbmumvmxbx(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_gg_tapvtbmumvmxbx() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_gg_tapvtbmumvmxbx() = delete; 
    ...
    // Matrix elements
    double matrix_1_gg_ttx_t_wpb_wp_tapvt_tx_wmbx_wm_mumvmx(); 
    double matrix_1_uux_ttx_t_wpb_wp_tapvt_tx_wmbx_wm_mumvmx(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_gg_tapvtbmumvmxbx >> > mapFinalStates;
