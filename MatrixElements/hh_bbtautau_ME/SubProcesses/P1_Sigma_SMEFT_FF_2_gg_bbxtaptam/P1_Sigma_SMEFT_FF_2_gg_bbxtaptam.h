...
class P1_Sigma_SMEFT_FF_2_gg_bbxtaptam: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_SMEFT_FF_2_gg_bbxtaptam(const ParameterSet& configuration); 
    virtual ~P1_Sigma_SMEFT_FF_2_gg_bbxtaptam() {}; 
  ...
  private:
    ...
    P1_Sigma_SMEFT_FF_2_gg_bbxtaptam() = delete; 
    ...
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_SMEFT_FF_2_gg_bbxtaptam >> > mapFinalStates;
