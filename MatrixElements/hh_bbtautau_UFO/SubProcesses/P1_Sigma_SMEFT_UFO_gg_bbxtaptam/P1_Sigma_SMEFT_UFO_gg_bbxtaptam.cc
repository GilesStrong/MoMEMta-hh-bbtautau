...
#include <P1_Sigma_SMEFT_UFO_gg_bbxtaptam.h> 
...
P1_Sigma_SMEFT_UFO_gg_bbxtaptam::P1_Sigma_SMEFT_UFO_gg_bbxtaptam(const
    ParameterSet& configuration)
{

  std::string param_card = configuration.get < std::string > ("card"); 
  params.reset(new Parameters_SMEFT_UFO(SLHA::Reader(param_card))); 
  ...
  {
    {
      &P1_Sigma_SMEFT_UFO_gg_bbxtaptam::matrix_1_gg_hh_h_bbx_h_taptam, 
      false, 
      {
        std::make_pair(21, 21)
      }, 
...
void P1_Sigma_SMEFT_UFO_gg_bbxtaptam::resetHelicities() 
{
...
std::map < std::pair < int, int > , double >
    P1_Sigma_SMEFT_UFO_gg_bbxtaptam::compute(const std::pair <
...
void P1_Sigma_SMEFT_UFO_gg_bbxtaptam::calculate_wavefunctions(const int perm[],
    const int hel[])
{
  ...
  VVSS2_0(w[0], w[1], w[4], w[7], params->GC_22, amp[0]); 
  SSS1_0(w[4], w[7], w[8], params->GC_28, amp[1]); 

}
double P1_Sigma_SMEFT_UFO_gg_bbxtaptam::matrix_1_gg_hh_h_bbx_h_taptam() 
{
...
REGISTER_MATRIX_ELEMENT("hh_bbtautau_UFO_SMEFT_UFO_P1_Sigma_SMEFT_UFO_gg_bbxtaptam", hh_bbtautau_UFO_SMEFT_UFO::P1_Sigma_SMEFT_UFO_gg_bbxtaptam); 
