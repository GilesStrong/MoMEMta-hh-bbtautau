...
class P1_Sigma_SMEFT_UFO_gg_bbxtaptam: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_SMEFT_UFO_gg_bbxtaptam(const ParameterSet& configuration); 
    virtual ~P1_Sigma_SMEFT_UFO_gg_bbxtaptam() {}; 
  ...
  private:
    ...
    P1_Sigma_SMEFT_UFO_gg_bbxtaptam() = delete; 
    ...
    // Matrix elements
    double matrix_1_gg_hh_h_bbx_h_taptam(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_SMEFT_UFO_gg_bbxtaptam >> > mapFinalStates;

    // Reference to the model parameters instance passed in the constructor
    std::shared_ptr < Parameters_SMEFT_UFO > params; 
