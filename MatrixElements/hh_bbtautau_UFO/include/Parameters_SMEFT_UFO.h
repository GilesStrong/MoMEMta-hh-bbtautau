...
class Reader;}
  ...
  class Parameters_SMEFT_UFO: public momemta::MEParameters
  {

    public:

      Parameters_SMEFT_UFO(const SLHA::Reader& card); 
      ...
      std::complex<double> GC_28, GC_31, GC_33; 
      // Model couplings dependent on aS
      std::complex<double> GC_22, GC_25; 
  }; 
